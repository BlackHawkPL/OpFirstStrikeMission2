//
	...
	ACE_medical_useLocation_SurgicalKit = 1;	//0: Field, 1: Medical Vehicle, 2: Medical Facility, 3: Vehicle OR Facility
	...
	ACE_medical_consumeItem_SurgicalKit = 1;	//0 Keep, 1 Consume
	ACE_medical_consumeItem_PAK = 1;

	ACE_medical_amountOfReviveLives = 0;		//Number of revives

	ACE_medical_enableFor = 0;					//0: No AI, 1: AI

	ACE_medical_maxReviveTime = 600;			//Time until death when unconscious

	ACE_medical_preventInstaDeath = false;		//Prevents instant death, will send you to revive mode always
